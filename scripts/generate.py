...
Usage:
  python3 scripts/generate.py    # render README.md from data
"""
...
def project_row(p):
    ...
    lic = p.get("license") or ("-" if p.get("oss") else "closed")
    ...
    return f"| {name} | {lic} | {backend} | {mcp} | {hosted} | {desc} |"
